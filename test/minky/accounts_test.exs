defmodule Minky.AccountsTest do
  use Minky.DataCase

  alias Minky.Accounts

  describe "users" do
    alias Minky.Accounts.User

    @valid_attrs %{email: "some email", name: "some name", password: "some password", password_confirmation: "some password_confirmation"}
